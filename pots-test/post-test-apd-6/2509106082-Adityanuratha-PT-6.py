...
while True:
    ...
    if username in users and users[username] == password:
        ...
        break
            ...
            print("Password atau username salah bang!silakan coba login kembali.")
...
while True:
    ...
    # CREATE
        ...
        if harga.isdigit() and stok.isdigit():
            ...
            barang[id_baru] = {"nama": nama, "harga": int(harga), "stok": int(stok)}
    ...
    # DELETE
        ...
        if not barang:
            ...
            if hapus.isdigit() and int(hapus) in barang:
                del barang[int(hapus)]
